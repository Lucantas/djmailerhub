"""
Django settings for mailerhubapi project.
...
ALLOWED_HOSTS = ["localhost", "mailerhubapi.herokuapp.com"]
...
ROOT_URLCONF = 'mailerhubapi.urls'
...
WSGI_APPLICATION = 'mailerhubapi.wsgi.application'
